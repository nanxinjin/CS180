...
public class SafeWalk extends Activity implements Observer {
	...
	moveSubmit.setOnClickListener(new View.OnClickListener() {
	    public void onClick(View v) {
	    	...
	    	String buildingName;
	    	buildingName = (String)locationsSpinner.getSelectedItem();
	    	String[] building = buildingName.split(" ");
	    	String buildingX = building[0];
	    	connector.writeLine("move" + " " + buildingX);
	    	}
	});
	

	// Callback method: Invoked when the user presses the "Request" button...
	requestSubmit.setOnClickListener(new View.OnClickListener() {
	    public void onClick(View v) {
	    	...
	    	String walkName;
	    	walkName = (String)requestsSpinner.getSelectedItem();
	    	String[] walking = walkName.split(" ");
	    	String walkingX = walking[0];
	    	connector.writeLine("walk" + " " + walkingX);
	    	}
	...
	private void handleRequestMessage(String[] fields) {
	    ...
	    // STEP 3: Create a String representation of the "request" message, add it to the locations ArrayList...
	    
	    String request = name + " : " + fromLocation + " " + toLocation + " " + value;
